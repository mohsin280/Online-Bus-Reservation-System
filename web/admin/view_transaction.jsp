<%-- 
    ...
    Created on : 23 Feb, 2021, 1:48:20 PM
    Author     : mohsi
--%>
...
<%! public ResultSet searchReserve(Connection con) throws SQLException {
        ...
        String check = " SELECT * FROM bus_db.reserve INNER JOIN bus_db.bus ON bus_db.reserve.bus_id = bus_db.bus.bus_id";
...
<td><a href="cancel_ticket_admin.jsp?id=<%=resultSet.getInt("trans_id") %>&amt=<%=resultSet.getInt("total_amt") %>&user=<%=resultSet.getString("username") %>">
